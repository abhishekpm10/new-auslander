            ...
            <Jumbotron className='task-page task-content-container'>
               ...
               {/* <Row><h3>{question}</h3></Row> */}
                ...
                />
                    ...
                    {
                        showAnswer?(<Button variant="outline-primary" style={{margin:'0px 5px'}}><Link to='/level4'> Previous Level</Link></Button>):null
                    }
                    {
                     showAnswer?(showAnswer[4]?<Button variant="outline-primary" style={{margin:'0px 5px'}}><Link to='/level6'> Next Level</Link></Button>:(submitAnswer?(submitAnswer[4]?<Button variant="outline-primary" style={{margin:'0px 5px'}}><Link to='/level6'> Next Level</Link></Button>:null):null)):null
                    }

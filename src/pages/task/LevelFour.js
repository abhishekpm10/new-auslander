    ...
    render() {
        ...
        return (
            <div>
               ...
               {
                   hint?(hint[3]?<h1>The Hint Is:{dataString}</h1>:null):null
               }
               {
                   showAnswer?(showAnswer[3]?<h1>The Answer Is:{correctAnswer}</h1>:null):null
               }
                <FormInput
                    type='text'
                    name='userAnswer'
                ...
                <Link to='/level3'>Previous Level</Link>
                {
                     showAnswer?(showAnswer[3]?<Link to='/level5'> Next Level</Link>:(submitAnswer?(submitAnswer[3]?<Link to='/level5'> Next Level</Link>:null):null)):null
                }
            </div>
        )
    }

            ...
            <Jumbotron className='task-page task-content-container'>
               ...
               {/* <Row><h3>{question}</h3></Row> */}
                ...
                />
                    ...
                    {
                        showAnswer?(<Button variant="outline-primary" style={{margin:'0px 5px'}}><Link to='/level1'> Previous Level</Link></Button>):null
                    }
                    {
                     showAnswer?(showAnswer[1]?<Button variant="outline-primary" style={{margin:'0px 5px'}}><Link to='/level3'> Next Level</Link></Button>:(submitAnswer?(submitAnswer[1]?<Button variant="outline-primary" style={{margin:'0px 5px'}}><Link to='/level3'> Next Level</Link></Button>:null):null)):null
                    }
